...
public class PhysicalLast extends UnaryAccumulator {
    ...
    protected abstract static class LastState extends UnaryState {
        ...
        protected LastState(BufferAllocator allocator, Field field, PhysicalLast accumulator) {
    ...
    protected static class IntLastState extends LastState {
        ...
        public IntLastState(BufferAllocator allocator, Field field, PhysicalLast accumulator) {
            super(allocator, field, accumulator);
        }
    ...
    protected static class BigIntLastState extends LastState {
        ...
        public BigIntLastState(BufferAllocator allocator, Field field, PhysicalLast accumulator) {
            super(allocator, field, accumulator);
        }
    ...
    protected static class Float4LastState extends LastState {
        ...
        public Float4LastState(BufferAllocator allocator, Field field, PhysicalLast accumulator) {
            super(allocator, field, accumulator);
        }
    ...
    protected static class Float8LastState extends LastState {
        ...
        public Float8LastState(BufferAllocator allocator, Field field, PhysicalLast accumulator) {
            super(allocator, field, accumulator);
        }
    ...
    protected static class VarCharLastState extends LastState {
        ...
        public VarCharLastState(BufferAllocator allocator, Field field, PhysicalLast accumulator) {
            super(allocator, field, accumulator);
        }
