...
public class PhysicalFirst extends UnaryAccumulator {
    ...
    protected abstract static class FirstState extends UnaryState {
        ...
        protected FirstState(BufferAllocator allocator, Field field, PhysicalFirst accumulator) {
    ...
    protected static class IntFirstState extends FirstState {
        ...
        public IntFirstState(BufferAllocator allocator, Field field, PhysicalFirst accumulator) {
            super(allocator, field, accumulator);
        }
    ...
    protected static class BigIntFirstState extends FirstState {
        ...
        public BigIntFirstState(BufferAllocator allocator, Field field, PhysicalFirst accumulator) {
            super(allocator, field, accumulator);
        }
    ...
    protected static class Float4FirstState extends FirstState {
        ...
        public Float4FirstState(BufferAllocator allocator, Field field, PhysicalFirst accumulator) {
            super(allocator, field, accumulator);
        }
    ...
    protected static class Float8FirstState extends FirstState {
        ...
        public Float8FirstState(BufferAllocator allocator, Field field, PhysicalFirst accumulator) {
            super(allocator, field, accumulator);
        }
    ...
    protected static class VarCharFirstState extends FirstState {
        ...
        public VarCharFirstState(BufferAllocator allocator, Field field, PhysicalFirst accumulator) {
            super(allocator, field, accumulator);
        }
